...
new B.widgets.Suggest(D.down("input[type=text]"),{script:"/xwiki/bin/view/Main/?xpage=suggest&classname=XWiki.TagClass&fieldname=tags&firCol=%2D&secCol=%2D&",varname:"input",seps:"|,",shownoresults:false,icon:"/xwiki/resources/icons/silk/tag_yellow.gif"})
}});
return B
}(XWiki||{}));
